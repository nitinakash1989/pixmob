...
```sh
$ kubectl get pods
$ kubectl exec postgres-<POD_IDENTIFIER> --stdin --tty -- createdb -U postgres users
```
...
1. [http://hello.world/users/ping](http://hello.world/users/ping)
1. [http://hello.world/users](http://hello.world/users)
